...
//            System.out.println(entry.getKey() + ": " + entry.getValue());
//        }
        Map<String, City> mostPopulatedCitiesByContinent = allCountries.values().stream()
                .flatMap(country -> country.getCities().stream()) // Flatten the cities from all countries
